...
var HomeResultsPage = /** @class */ (function () {
    function HomeResultsPage(api, storage, navCtrl, menuCtrl, popoverCtrl, alertCtrl, modalCtrl, toastCtrl) {
        var _this = this;
        this.api = api;
    ...
    HomeResultsPage.prototype.getProfile = function () {
        /*if(this.userid <= 0){
    ...
    HomeResultsPage.prototype.getVisites = function () {
        var _this = this;
        this.api.getAllVisites(this.userid).subscribe(function (data) {
            console.log(data);
            if (data["success"]) {
                _this.visites = data["result"];
                _this.storage.set('visites', _this.visites);
            }
            else {
                _this.storage.get('visites').then(function (val) {
                    _this.visites = val;
                });
            }
        });
    ...
    //#region  Redirection
    HomeResultsPage.prototype.goToVisite = function (visite) {
